...
window.Physijs = (function() {
	...
	Physijs.Scene.prototype.add = function( object, opts) {
		opts = opts || {}
		if (! opts.notToWorld) THREE.Mesh.prototype.add.call( this, object );
		...
		if ( object._physijs ) {
			...
			if(opts.container) object._physijs.position = { x: opts.parent.position.x, y: opts.parent.position.y, z: opts.parent.position.z };
			if (!object.useQuaternion) {
