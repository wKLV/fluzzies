...
lime.Polygon.prototype.addPoints = function(points) {
    if(!(points instanceof Array)|| typeof points === "undefined") points = goog.array.toArray(arguments);
...
lime.Renderer.CANVAS.POLYGON.draw = function(context) {
    ...
    if (pt.length > 2) {
       ...
       if(fill) if(fill.str)
        ...
        else if(fill.image_) context.fillStyle = context.createPattern(fill.image_, 'repeat');
